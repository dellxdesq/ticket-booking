...
const file_proto_notifications_proto_rawDesc = "" +
	"\n" +
	"\x19proto/notifications.proto\x12\rnotifications\"R\n" +
	...
	"\tSendEmail\x12\x1b.notifications.EmailRequest\x1a\x1c.notifications.EmailResponseB\x1cZ\x1a./proto/grpc/notificationsb\x06proto3"
...
var file_proto_notifications_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_notifications_proto_goTypes = []any{
	(*EmailRequest)(nil),  // 0: notifications.EmailRequest
	(*EmailResponse)(nil), // 1: notifications.EmailResponse
}
var file_proto_notifications_proto_depIdxs = []int32{
	0, // 0: notifications.NotificationService.SendEmail:input_type -> notifications.EmailRequest
	1, // 1: notifications.NotificationService.SendEmail:output_type -> notifications.EmailResponse
